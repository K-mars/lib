...
function browserResize() {
  if (Number(kmars_getStyleValue(document.getElementById("main"), "height").replace("px", "")) > 2200) {
...
function kmars_close_all_nav() {
  kmars_close_all_topnav();
  close_menu();
}
function kmars_close_all_topnav() {
  kmars_close_nav("tutorials");
  kmars_close_nav("references");
  kmars_close_nav("examples");
}
(function () {
  var x, i, a, b, c, d, m;
  m = (document.getElementById("leftmenu") || document.getElementById("sidenav"));
  ...
  for (i = 0; i < x.length; i++) {
    ...
    b = x[i].pathname;
    if ((x[i].parentNode.tagName == "LI" || x[i].parentNode.className.indexOf("kmars-bar") > -1) && a.substr(0, a.indexOf("/",1)) ==  b.substr(0, b.indexOf("/",1))) {
      x[i].className += " active";
    }
  }
  if (window.addEventListener) { 
    document.getElementById("main").addEventListener("click", kmars_close_all_nav, true);
    m.addEventListener("click", kmars_close_all_topnav, true);
    document.getElementById("right").addEventListener("click", kmars_close_all_nav, true);
  } else if (window.attachEvent) {         
    document.getElementById("main").attachEvent("onclick", kmars_close_all_nav);
    m.attachEvent("onclick", kmars_close_all_topnav);
    document.getElementById("right").attachEvent("onclick", kmars_close_all_nav);
  }
...
function searchfield_focus(obj) {
  obj.style.color = "";
  obj.style.fontStyle = "";
  if (obj.value == "Search kmarsweb.blogspot.com") {obj.value = "";}
}
...
/* kmarscodecolor ver 1.31 by kmarsweb */
(
function kmarsCodeColor() {
...
for (j = 0; j < k; j++) {
  ...
  l = x.length;
  for (i = 0; i < l; i++) {
    x[i].innerHTML = kmarsCodeColorize(x[i].innerHTML + " ", modes[j]);
  }
}
function kmarsCodeColorize(x, lang) {
  var tagcolor = "cyan";
  var tagnamecolor = "mediumblue";
  var attributecolor = "Chocolate";
  var attributevaluecolor = "lime";
  var commentcolor = "yellowgreen";
  var cssselectorcolor = "blue";
  var csspropertycolor = "brown";
  var csspropertyvaluecolor = "lime";
  var cssdelimitercolor = "black";
  var cssimportantcolor = "lime";  
  var jscolor = "teal";
  var jskeywordcolor = "lime";
  var jsstringcolor = "DodgerBlue";
  var jsnumbercolor = "GoldenRod";
  var jspropertycolor = "green";
  var phptagcolor = "cyan";
  var phpcolor = "teal";
  var phpkeywordcolor = "lime";
  var phpglobalcolor = "goldenrod";
  var phpstringcolor = "DodgerBlue";
  var phpnumbercolor = "GoldenRod";  
  var pythoncolor = "teal";
  var pythonkeywordcolor = "lime";
  var pythonstringcolor = "DodgerBlue";
  var pythonnumbercolor = "GoldenRod";  
  var angularstatementcolor = "purple";
  var sqlcolor = "teal";
  var sqlkeywordcolor = "lime";
  var sqlstringcolor = "DodgerBlue";
  var sqlnumbercolor = "GoldenRod";  
  if (!lang) {lang = "html"; }
  ...
  function htmlMode(txt) {
    ...
    php = new extract(rest, "&lt;\\?php", "?&gt;", phpMode, "kmarsPHPPOS");
    rest = php.rest;
    comment = new extract(rest, "&lt;!--", "--&gt;", commentMode, "kmarsHTMLCOMMENTPOS");
    rest = comment.rest;
    ...
    for (i = 0; i < comment.arr.length; i++) {
        rest = rest.replace("kmarsHTMLCOMMENTPOS", comment.arr[i]);
    }
    for (i = 0; i < php.arr.length; i++) {
        rest = rest.replace("kmarsPHPPOS", php.arr[i]);
    }
    return rest;
  }
  ...
  function cssMode(txt) {
    ...
    comment = new extract(rest, /\/\*/, "*/", commentMode, "kmarsCSSCOMMENTPOS");
    rest = comment.rest;
    while (rest.search("{") > -1) {
      s = rest.search("{");
    ...
    rest = rest.replace(/}/g, "<span style=color:" + cssdelimitercolor + ">}</span>");
    for (i = 0; i < comment.arr.length; i++) {
        rest = rest.replace("kmarsCSSCOMMENTPOS", comment.arr[i]);
    }
  ...
  function jsMode(txt) {
    ...
    for (i = 0; i < esc.length; i++) {
      rest = rest.replace("kmarsJSESCAPE", esc[i]);
    }
