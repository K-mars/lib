...
function submitTryit(n) {
  ...
  if (loadSave == true ) {
    ...
    document.getElementById("codeForm").action = "https://kmarsweb.blogspot.com/tryit-save.html?x=" + Math.random();
...
function showFrameSize() {
  var t;
  var width, height;
  width = Number(kmars_getStyleValue(document.getElementById("iframeResult"), "width").replace("px", "")).toFixed();
  height = Number(kmars_getStyleValue(document.getElementById("iframeResult"), "height").replace("px", "")).toFixed();
...
function fixDragBtn() {
  ...
  var containertop = Number(kmars_getStyleValue(document.getElementById("container"), "top").replace("px", ""));
  if (stack != " horizontal") {
    document.getElementById("dragbar").style.width = "5px";    
    textareasize = Number(kmars_getStyleValue(document.getElementById("textareawrapper"), "width").replace("px", ""));
    leftpadding = Number(kmars_getStyleValue(document.getElementById("textarea"), "padding-left").replace("px", ""));
    buttonwidth = Number(kmars_getStyleValue(document.getElementById("dragbar"), "width").replace("px", ""));
    textareaheight = kmars_getStyleValue(document.getElementById("textareawrapper"), "height");
...
var createFileWithHTMLContent = function(name,data,callback) {
    ...
    if (!callback) {
        callback = function(file) {
            ...
            document.getElementById("driveSavedPanel").className = "kmars-panel kmars-large";
        };
    }
...
function resetDriveSaveModal() {
    ...
    document.getElementById("driveSavedPanel").className = "kmars-panel kmars-large loader";
}
...
function saveFile(code) {
    ...
    if(httpB.readyState == 4 && httpB.status == 200) {
        if(httpB.responseText.substr(0,2) == "OK" ) {
          ...
          document.getElementById("shareLinkText").innerHTML = "https://www.kmarsschools.com/code/tryit.asp?filename=" + getId;
...
function openMenu() {
    ...
    if (z.className.indexOf("kmars-text-gray") == -1) {
        z.className += " kmars-text-gray";
    } else { 
        z.className = z.className.replace(" kmars-text-gray", "");
    }
    if (z.className.indexOf("kmars-gray") == -1) {
        z.className += " kmars-gray";
    } else { 
        z.className = z.className.replace(" kmars-gray", "");
    }
    if (x.className.indexOf("kmars-show") == -1) {
        x.className += " kmars-show";
    } else { 
        x.className = x.className.replace(" kmars-show", "");
    }
    if (y.className.indexOf("kmars-show") == -1) {
        y.className += " kmars-show";
    } else { 
        y.className = y.className.replace(" kmars-show", "");
    }
